...
export default function OpenStopMapPicker({ stopName, latitude, longitude, onClose, onConfirm }: StopMapPickerProps) {
  ...
  useEffect(() => {
    ...
    const fallbackTimer = window.setTimeout(() => {
      if (!map.isSourceLoaded(openMapConfig.primarySourceId)) {
