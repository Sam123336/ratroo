...
type JourneyLeg = {
  ...
  stopCount?: number;
  /** Minutes waiting at this leg's boarding stop. */
  waitMinutes?: number;
  /** True when that wait is an estimate, not a published timetable gap. */
